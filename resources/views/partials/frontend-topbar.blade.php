    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            <div class="user col align-self-end">
                <img src="{{ asset('frontend/images/faces/1.jpg') }}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Create Your Startup Profile</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <form action="{{ route("client.startup.fastcreate") }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="col-md-12 form-group mb-3">
                        <label for="company_name"><b>Startup Name</b></label>
                        <input class="form-control form-control-rounded" name="company_name" id="company_name" type="text" placeholder="Enter your startup name">
                    </div>

                    <div class="col-md-12 form-group mb-3">
                        <label for="slug_name"><b>Your startup URL</b></label>
                        <input class="form-control form-control-rounded" name="slug_name" id="slug_name" type="text" placeholder="@startupName">
                    </div>
