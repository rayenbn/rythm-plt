      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">Universities Table</h4>
          </div>
          <div class="card-body">
            <router-link
...
export default {
  ...
  computed: {
    ...mapGetters('UniversitiesIndex', ['data', 'total', 'loading'])
  },
  watch: {
    query: {
      handler(query) {
  ...
  methods: {
    ...mapActions('UniversitiesIndex', ['fetchIndexData', 'setQuery', 'resetState'])
  }
}
</script>
